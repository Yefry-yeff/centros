...
<html lang="en">
    ...
    <div class="py-12">
            ...
            <div class="container" style="opacity: .9; ">
                <div class="shadow-lg p-3 mb-5 bg-white rounded rounded-lg border border-success">
                    <!-- <x-jet-welcome /> -->
                    <!-- Formulario -->
                    <div class="container">
                        ...
                        <form class=" form form-group" id="formu">
                            ...
                            <select required name="cantidad" class="form-control form-control-sm"  id="canPersonas" > Cantidad de personas
                                <option selected value="" disabled required>Cantidad de personas</option>
                        ...
                        <br>
                        <button type="submit" style="width: 100%; " onclick="validar()" id="btnGuardar" class="btn btn-success btn-sm btn-block" >Guardar</button>
            ...
            function validar(){
                ...
                if(identidad.value ==""){
                    ...
                    text: 'Debes ingresar tu número de identidad'
                        ...
                        icon: 'warning',
                        title: 'Uups...!',
                        text: 'Debes ingresar una cantidad de personas'
                    })
